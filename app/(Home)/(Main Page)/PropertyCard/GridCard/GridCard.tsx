...
import css from './GridCard.module.css';
...
const GridPropertyComponent: React.FC<GridPropertyProps> = ({
  properties,
  expandedCard,
  handleCardClick,
}) => {
  return (
    <article className={css.allPropertiesGrid}>
...
export default GridPropertyComponent;
