...
async function getClaimableAmount(propertyContractAddress: string, tokensIds: any) {
  ...
  const claimableAmountHex = await propertyContract.calculateClaimable(tokenId);
