...
const TokenProgress: React.FC<TokenProgressProps> = ({
  ...
  return (
    <div className="flex gap-6 items-center justify-between">
      ...
      <p className="flex-shrink-0 px-4 py-1 bg-orange-300 bg-opacity-30 rounded-[50px] border border-orange-500 items-center justify-center text-orange-500 text-sm font-semibold">
