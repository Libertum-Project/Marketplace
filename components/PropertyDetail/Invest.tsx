    ...
    <div className="max-w-lg mx-auto bg-white shadow-md rounded p-6 space-y-4">
      ...
      <div className='flex gap-2 justify-between items-center border rounded-[5px]'>
        <div className="flex flex-1">
          ...
          <div className="flex-1">
            <p className="text-gray-700 text-lg px-3 py-2 bg-gray-100 rounded-r-lg">6%</p>
          </div>
        </div>
      </div>
      ...
      <div className='flex gap-2 justify-between items-center border rounded-[5px]'>
        <div className="flex flex-1">
          ...
          <div className="flex-1">
            <p className="text-gray-700 text-lg px-3 py-2 bg-gray-100 rounded-r-lg">$5000</p>
          </div>
        </div>
      </div>
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button type="submit" className="px-3 bg-teal-500 w-fit text-white rounded hover:bg-teal-600 transition duration-300 flex items-center justify-center font-space_grotesk'">
            Subscribe
          </Button>
        </div>
      </DialogContent>
