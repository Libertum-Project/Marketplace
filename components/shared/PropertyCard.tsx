          ...
          <div className="py-4 px-16 w-full flex gap-10 justify-between divide-x">
            ...
            <div className="flex flex-col justify-between py-6 pl-8">
              <div className="grid grid-cols-2 gap-2">
                <p><span className='font-semibold'>Capital Repayment:</span> 3.33% </p>
                <p><span className='font-semibold'> Repayment Term:</span> 30 years</p>
                <p><span className='font-semibold'>Icome per token:</span> $2.75</p>
                <p><span className='font-semibold'>Price per Token:</span> $50</p>
              </div>
