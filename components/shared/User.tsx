  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <div
          className="bg-gray-950 bg-opacity-5 rounded-[48px] border border-black border-opacity-10 flex justify-between gap-3 p-2 items-center cursor-pointer max-sm:bg-white"
