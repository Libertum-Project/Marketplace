...
export const OilListCard: React.FC<OilCardProps> = ({ oil }) => {
  const { quantity, handleChange, calculatedPrice, calculatedGuarantee } = useOilLogic(oil);

  return (
    <CardContent className="p-0 flex w-full max-h-[176px]">
      <ServerImage src={oil.image} alt={oil.name} width={250} height={166} className="w-auto" />
