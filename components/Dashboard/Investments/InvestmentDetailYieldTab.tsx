...
const InvestmentDetailYieldTab = ({ propertyAddress, durationInMonths, isTest }: props) => {
  ...
  if (isTest && propertyAddress === '0xd2a9dbBf8A4E1E5b8Ccd205FF8b84dB82b78FE44') {
    return <MockProperty1 />;
  }

  if (isTest && propertyAddress === '0x04401e20DbF805DAe2f5Dc5C4217815f7149b24D') {
      ...
      <div className="py-10 max-sm:py-10 flex gap-10 flex-col">
        <div className="flex justify-between flex-col items-start gap-3">
          ...
          <p className="flex-shrink-0 items-start justify-start text-slate-600 text-sm font-semibold mx-4 w-[300px] text-start">
            Remaining months to claim: <b>{durationInMonths} months</b>
          </p>
        </div>
