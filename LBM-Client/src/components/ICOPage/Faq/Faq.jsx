...
const Faq = () => {
    ...
    const inputProps = {
        ...
        onChange: onChange,
        style: {
            width: '80%', // Cambia el ancho según tus necesidades
    ...
    return (
        <div className={`${styles.container} bg-gray-800 py-10 pb-20 border-t lg:px-20 px-4`} >
            ...
            <h2 className='text-orange-400 text-3xl'>About Libertum</h2>
            <p className='text-gray-100'>FAQs about the company</p>
