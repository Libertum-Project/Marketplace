...
const ICO = () => {
    return (
        <div>
            <section className="text-gray-600 body-font pt-4 bg-gray-900 md:h-[700px] mt-24  ">
                ...
                <div className="relative z-1 mx-auto container block md:flex pb-24 md:flex-row items-center ">
                    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center mt-40">
                        <h1 className="text-3xl md:text-5xl mb-4 -mt-32 font-semibold text-white ">
                            Join The <span className='bg-gradient-to-r from-blue-600 to-lime-400 text-transparent bg-clip-text'>Green Revolution</span>
                            <br className="hidden lg:inline-block" />Get Youe $TUK Token Now!
                        </h1>
                    ...
                    <div className=" shadow-2xl rounded-t-3xl md:mt-20 md:-mr-[74px] px-5 md:px-0 -mt-10">
                        <div className='bg-gray-800 text-white p-5 text-center rounded-t-3xl'>
                            ...
                            <button className='bg-green-600 md:px-20 px-10 py-1 md:py-2 rounded-3xl mb-4'>SOLD 2,498,846/5,000,000 $TUK TOKEN </button>
                        ...
                        <div className='bg-white text-center'>
                            ...
                            <div className='flex md:justify-around md:pt-5 p-2 '>
                                <div className='md:px-2 '>
                                    <p className='md:mb-5'>Amount of USD you pay</p>
                                    <div className='flex bg-gray-300 rounded-lg w-[130px] mx-auto'>
                                        <input type="text" placeholder='0' className='py-1 md:py-3 pl-5 rounded-xl md:text-lg  bg-gray-300 w-[90px]' />
                                        <h2 className='font-bold  md:pr-4 md:mt-3'>USD</h2>
                                    </div>
                                </div>
                                <div className='md:px-2'>
                                    <p className='md:mb-5'>Amount of USD you Recieve</p>
                                    <div className='flex rounded-lg bg-gray-300 w-[130px] mx-auto'>
                                        <input type="text" placeholder='0' className='py-1 md:py-3 pl-5 rounded-xl md:text-lg  bg-gray-300 w-[90px]' />
                                        <h2 className='font-bold md:pr-4 md:mt-3'>USD</h2>
                                    </div>
                                </div>
