...
const Roadmap = () => {
    return (
        <div className="bg-gray-800 p-16 text-white border-t">
            ...
            <div className="lg:flex justify-between items-start relative lg:p-10 text-left">
...
const Phase = ({ title, tasks }) => (
    <div className="lg:flex flex-col items-center relative z-10 animate-fadeIn mt-10 lg:mt-0" >
        ...
        <div className="mb-4 lg:w-24 h-24 bg-orange-400 rounded-full flex items-center justify-center shadow-2xl transform transition-transform hover:scale-105 hover:shadow-xl">
